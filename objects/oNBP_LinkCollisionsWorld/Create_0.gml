...
box4 = instance_create_layer(room_width * 4.5 / 8, room_height * 0.125, "Instances", oNBP_BoxSV);
box5 = instance_create_layer(room_width * 5.5 / 8, room_height * 0.125, "Instances", oNBP_BoxSV);
